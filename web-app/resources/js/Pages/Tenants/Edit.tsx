        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                ...
                <div className="flex flex-1 flex-col pb-8">
                    <div className="flex flex-col gap-4 py-4 md:gap-8 md:py-8 px-4 lg:px-6 max-w-3xl mx-auto w-full">
                        {/* Header */}
                        <div className="flex items-start md:items-center gap-3 md:gap-4 mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-xs md:text-base text-gray-500 mt-0.5 md:mt-1">
                        ...
                        <form onSubmit={submit}>
                            <Card className="rounded-2xl md:rounded-3xl border-none shadow-sm md:shadow-md overflow-hidden bg-white">
                                <CardHeader className="bg-gray-50/50 p-5 md:p-6 pb-4 md:pb-6 border-b border-gray-100">
                                    <div className="flex items-center gap-2 md:gap-3">
                                        <div className="p-2 md:p-2.5 bg-indigo-50 rounded-xl md:rounded-2xl shrink-0">
                                ...
                                <CardContent className="p-5 md:p-6 space-y-4 md:space-y-6">
                                    <div className="space-y-1.5 md:space-y-2">
                                        ...
                                        <Input
                                            ...
                                            className="h-11 md:h-12 rounded-xl border-gray-200 bg-gray-50 focus:bg-white text-sm"
                                            required
                                        />
                                        {errors.name && (
                                    ...
                                    <div className="space-y-1.5 md:space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="pt-sukses-makmur"
                                            className="h-11 md:h-12 rounded-xl border-gray-200 bg-gray-50 focus:bg-white font-mono text-sm"
                                            required
                                        />
                                        {errors.slug && (
                                            <p className="text-[10px] md:text-xs text-red-500 font-medium">
                                ...
                                <CardFooter className="p-5 md:p-6 bg-gray-50/50 border-t border-gray-100 flex flex-col-reverse md:flex-row justify-end gap-2 md:gap-3">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        asChild
                                    ...
                                    <Button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full md:w-auto h-11 md:h-10 bg-indigo-600 hover:bg-indigo-700 text-white md:px-8 rounded-xl font-bold shadow-lg shadow-indigo-200"
                                    >

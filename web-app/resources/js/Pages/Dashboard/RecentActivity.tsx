...
// ─── Superadmin View ─────────────────────────────────────────────────────────
function SuperadminTable({ data }: { data: any[] }) {
    return (
                    ...
                    {data.map((tenant) => (
                        ...
                        >
                            ...
                            <div className="flex gap-4 text-sm text-gray-500">
                                ...
                                <span>{tenant.attendances_count} Absensi</span>
                            </div>
                            <p className="text-xs text-gray-400">
                                Bergabung {formatDateShort(tenant.created_at)}
                            </p>
                        </div>
                    ))}
                </div>
...
export default function RecentActivity({ role, data }: Props) {
    if (role === 'superadmin') {
        return <SuperadminTable data={data} />;
    }
